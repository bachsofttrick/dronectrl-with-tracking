            ...
            if self.faces_found > 0:
                ...
                for i in range(self.faces_found):
                    ...
                    if (self.bb[i][3]-self.bb[i][1])/frame.shape[0]>0.1:
                        ...
                        # 
                        self.bach_count = (self.bach_count + 1) if (self.best_name == 'bach' and self.best_class_probabilities > 0.7) else self.bach_count
                        ...
                        if self.best_class_probabilities > 0.7:
                            if self.bach_count > 1 and self.best_name == 'bach':
                                print('Lose 1 bach!')
                                pass
                            else:
                                self.bbox_result.append([self.bb[i][0], self.bb[i][1], self.bb[i][2], self.bb[i][3], self.best_name, self.best_class_probabilities])
        except:
            pass
