...
void loop(){
  ...
  timer_channel_3 = pitch + loop_timer;                                     //Calculate the time of the faling edge of the esc-3 pulse.
  timer_channel_4 = roll + loop_timer;                                      //Calculate the time of the faling edge of the esc-4 pulse.
